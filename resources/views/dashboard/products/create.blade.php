<x-layouts.app :title="__('Add New Product')">
    ...
    <form action="{{ route('products.store') }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="mb-3">
            ...
            <label><input type="radio" name="image_source" value="file" checked onchange="toggleImageInput()"> Upload File</label>
            <label class="ml-4"><input type="radio" name="image_source" value="url" onchange="toggleImageInput()"> Use URL</label>
        </div>
